...
{
    public class AreaClearance1_Component : ToolpathBase_Component
    {

        public AreaClearance1_Component()
        ...
        protected override System.Drawing.Bitmap Icon => Toolpaths01.GH.Properties.Resources.tasMachine_AreaClearance;

        public override Guid ComponentGuid => new Guid("{c34d5894-7cec-404b-8cf1-89f5df913ba7}");
