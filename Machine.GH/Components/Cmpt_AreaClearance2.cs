...
{
    public class tasTP_AreaClearance2_Component : GH_Component
    {
        ToolSettings Tool = new ToolSettings();
        tasTP_ToolSettings_Form form;

        public tasTP_AreaClearance2_Component()
          : base("tasToolpath: Roughing Area Clearance2", "tasTP: Area Clearance2",
