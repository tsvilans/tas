...
namespace tas.Machine.GH
{
    ...
    public class tasTP_CreateRobotTargets_Component : GH_Component
    {
        ToolpathSettings settings = new ToolpathSettings();
        tasTP_Processor2Settings_Form form;

        private object Safety = null;

        public tasTP_CreateRobotTargets_Component()
        ...
        private void SettingsClicked(object sender, ToolStripItemClickedEventArgs e)
        {
            ...
            {
                form = new tasTP_Processor2Settings_Form(this, settings);
                if (form != null)
                    form.Show();
                return;
            }
        ...
        {
            get { return new Guid("{8b2880c6-86f5-4c62-99fd-727b1cc61a60}"); }
        }
    }
#endif
}