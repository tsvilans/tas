...
{
    public class tasTP_CircularFingerJoint_Component : GH_Component
    {
        public tasTP_CircularFingerJoint_Component()
          : base("tasToolpath: Finger Joint Circular", "tasTP: CircFJ",
