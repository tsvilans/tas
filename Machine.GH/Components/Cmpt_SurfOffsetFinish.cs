...
{
    public class tasTP_SurfOffsetFinish_Component : GH_Component
    {

        public tasTP_SurfOffsetFinish_Component()
          : base("tasToolpath: Finish Surface Offset ", "tasTP: Surf Offset Finish",
